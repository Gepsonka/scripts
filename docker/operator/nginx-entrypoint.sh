...
#
# The frappe-operator runs the nginx component with args
# ["nginx-entrypoint.sh"] and BACKEND/SOCKETIO env vars pointing at the
# bench-internal services. This renders the nginx config from the template
# and starts nginx in the foreground.
